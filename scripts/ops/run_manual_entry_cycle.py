...
from scripts.quant_runtime_bridge import load_quant_runtime_contracts
...
try:
    ...
    from scripts.ops.run_shadow_preflight_cycle import DEFAULT_QUANT_ROOT, _add_src_paths, _load_latest_audit_event, _summarize_preflight_result
...
def main() -> int:
    ...
    payload = run_cycle(args=args, bot_root=repo_root_from_script(__file__))
    if args.json:
