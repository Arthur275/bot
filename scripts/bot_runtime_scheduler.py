...
def default_runtime_root() -> str:
    return str(Path(__file__).resolve().parents[1] / "runtime" / "bot_runtime_scheduler")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    def add_common(subparser: argparse.ArgumentParser) -> None:
        ...
        subparser.add_argument("--kill-switch-path", default=str(Path(__file__).resolve().parents[1] / "runtime" / "controls" / "disable_real_execution.flag"))
